...
.controller( "signupcontroller", ["$scope", "$state", "UserService", "Upload", "$rootScope", function SignupController( $scope, $state, UserService, Upload, $rootScope) {
 ...
 angular.module('bmuApp').directive('username', ["$http", "$q", function($http, $q) {
    return {
        require: 'ngModel',
...
angular.module('bmuApp').directive('email', ["$http", "$q", function($http, $q) {
   return {
       require: 'ngModel',
       link: function(scope, element, attrs, ngModel) {

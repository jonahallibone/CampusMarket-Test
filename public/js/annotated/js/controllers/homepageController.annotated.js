...
angular.module('bmuApp', [
  ...
  'bmuApp.pmessenger',
  'bmuApp.profile'
]).config( ["$urlRouterProvider", "$urlMatcherFactoryProvider", "jwtInterceptorProvider", "$httpProvider", "$locationProvider", function myAppConfig ($urlRouterProvider, $urlMatcherFactoryProvider, jwtInterceptorProvider, $httpProvider,$locationProvider) {
...
.run(["$rootScope", "$state", "$stateParams", "store", "jwtHelper", "UserService", function($rootScope, $state, $stateParams, store, jwtHelper, UserService) {
...
//Report Post Modal
angular.module('bmuApp').controller('reportPostModal', ["$scope", "$uibModal", "$log", function($scope, $uibModal, $log) {
...
//Add Post Modal
angular.module('bmuApp').controller('addPostModal', ["$scope", "$uibModal", "$log", function($scope, $uibModal, $log) {
...
/****EDIT POST MODAL**/
 angular.module('bmuApp').controller('editPostModal', ["$scope", "$uibModal", "$log", function($scope, $uibModal, $log) {
 ...
 angular.module('bmuApp').controller('ReportModalInstanceCtrl', ["$scope", "$http", "$state", "Upload", "$rootScope", "$uibModalInstance", "post", "posts", function ($scope, $http, $state, Upload, $rootScope, $uibModalInstance, post, posts) {
 ...
 angular.module('bmuApp').controller('EditModalInstanceCtrl', ["$scope", "$http", "$state", "Upload", "$rootScope", "$uibModalInstance", "post", function ($scope, $http, $state, Upload, $rootScope, $uibModalInstance, post) {
 ...
 angular.module('bmuApp').controller('ModalInstanceCtrl', ["$scope", "$http", "$state", "Upload", "$rootScope", "$uibModalInstance", function ($scope, $http, $state, Upload, $rootScope, $uibModalInstance) {
...
angular.module('bmuApp').directive('searchAble', ["$state", "$stateParams", function($state, $stateParams) {
  return {
        restrict: 'A',
...
angular.module('bmuApp').directive('messageNoti', ["$timeout", function($timeout){
  return {
    scope: {
      alert: '=messageNoti',
      alerts: '=messageArray'
...
/***APP RUN*******/
/*****************/
angular.module('bmuApp').run(["$rootScope", "UserService", "$pusher", function($rootScope, UserService, $pusher) {
  $rootScope.alerts = [];

...
.controller( "profilecontroller", function ProfileController( $scope, $http, $state, UserService, Upload, $rootScope, $stateParams, URL_BASE, $timeout, uiGmapGoogleMapApi) {
  ...
  //Init update object
    ...
    $scope.addToTradeList = function() {
      if(!$scope.newItem.item.replace(/\s/g, '').length) {
        return
      }
      $http({
        url: 'https://'+URL_BASE+'/api/tradelist',
...
angular.module('bmuApp').controller('changeProPic', function($scope, $uibModal, $log, Upload) {
 ...
 angular.module('bmuApp').controller('ProPicModalInstanceCtrl', function ($scope, $http, $state, Upload, $rootScope, $uibModalInstance, user) {
...
angular.module( 'bmuApp.profile')
.controller( "otherprofilecontroller", function OtherProfileController( $scope, $http, $state, UserService, Upload, $rootScope, $stateParams, URL_BASE, uiGmapGoogleMapApi, $timeout) {
